...
const PersonalInfo = (props) => {
  ...
  return (
    <div className="p-0 m-0 row w-100">
      ...
      <div
        className={`form-group col-12  ${
          comeFrom == "us" ? "col-sm-12" : "col-md-6 pr-md-3  "
        } ${otherFormik && "col-md-6"} p-0 m-0 p-1`}
      >
        {/* <NumberFormat
          prefix="+"
      ...
      {complete && (
        <>
          ...
          >
            <lable className="label_style">Birth Date (required)</lable>
            {/* <input
              type="text"
              name="user_birthday"
              className="form-control eforms_input_container"
            ...
            /> */}
            <DatePickerCustom  formik={formik} name="user_birthday"  value={formik.values.user_birthday}/>
