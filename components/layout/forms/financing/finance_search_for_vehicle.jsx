...
const FinanceSearchForVehicle = (props) => {
  const { vehicleDataForSearch, formik, advanceSearchCar } = props;
  ...
  const handleSelectVehicle = (id, name) => {
    if (formik.values.frk_desire_MidVclDS_id !== id) {
      ...
      formik.setFieldValue("desired_mid_vehicle", null);
      formik.setFieldTouched("frk_midv_id", false);
    }
  ...
  return (
    <div className="p-0 m-0 w-100">
      ...
      >
        <input
          ref={inputRef}
          name="frk_desire_MidVclDS_id"
          className="form-control  eforms_input_container"
          placeholder="Search (Year Make Model)"
          onChange={handleSearchBoxChange}
        />
        {((formik.errors.frk_desire_MidVclDS_id &&
          formik.touched.frk_desire_MidVclDS_id) ||
          (formik.errors.desired_mid_vehicle &&
            formik.touched.desired_mid_vehicle)) && (
          ...
          >
            ...
            >
              ...
              {/* {searchResult?.length === 0 && (
                <div className="p-0 m-0 d-none col-12">
