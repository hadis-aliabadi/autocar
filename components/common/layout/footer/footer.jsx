...
const FooterCustomerWeb = React.forwardRef((props, ref) => {
  ...
  return (
    <>
      ...
      <div
        className="p-0 m-0 footer_div_container row w-100 justify-content-center px-2"
      ...
      >
        <div
          ...
          style={{ backgroundColor: "#333" }}
        >
          <div className="p-0 m-0 col-12 col-md-12  col-xl-10 row flex-lg-row footer-style-in-tablet pt-xl-3  justify-content-center">
